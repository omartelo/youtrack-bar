...
`w` on a filter polls it in the background. When an issue turns up that was not
there before, you get a desktop notification and the issue is marked `●` in the
